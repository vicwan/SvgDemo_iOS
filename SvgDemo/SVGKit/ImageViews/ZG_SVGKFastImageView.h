 ...
 * SVGKit's version of UIImageView - with some improvements over Apple's design
 ...
 - because of the way this class works, any animations you add to the SVGKImage's CALayerTree *will be ignored*. If you need to animate the elements of an SVG file, use ZG_SVGKLayer instead (although that class is missing some of the features of this class, and is a little harder to use)
 ...
 - ZG_SVGKImageView *skv = [[ZG_SVGKImageView alloc] initWithSVGKImage: [ZG_SVGKImage imageNamed:@"image.svg"]];
 ...
 - FOR VERY ADVANCED USAGE: instead of this class, use the lower-level "ZG_SVGKLayeredImageView" class, which lets you modify every individual layer
 ...
 */
@interface ZG_SVGKFastImageView : ZG_SVGKImageView
