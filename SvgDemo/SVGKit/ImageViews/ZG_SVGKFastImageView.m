...
@interface ZG_SVGKFastImageView ()
...
@implementation ZG_SVGKFastImageView
{
...
- (void)populateFromImage:(ZG_SVGKImage*) im
{
	...
	if( im == nil )
	{
		SVGKitLogWarn(@"[%@] WARNING: you have initialized an ZG_SVGKImageView with a blank image (nil). Possibly because you're using Storyboards or NIBs which Apple won't allow us to decorate. Make sure you assign an ZG_SVGKImage to the .image property!", [self class]);
	}
...
-(void)drawRect:(CGRect)rect
{
	...
	/**
	 ...
	 imageBounds == natural width and height of the ZG_SVGKImage
	 */
