...
@implementation ZG_SVGKSourceURL
...
+ (ZG_SVGKSource*)sourceFromURL:(NSURL*)u {
	...
	ZG_SVGKSourceURL* s = [[ZG_SVGKSourceURL alloc] initWithInputSteam:stream];
	s.URL = u;
...
-(id)copyWithZone:(NSZone *)zone
{
	...
	{	
		...
		[copy setStream:[[self class] internalCreateInputStreamFromURL:((ZG_SVGKSourceURL*)copy).URL]];
	}
