...
@interface ZG_SVGKSourceLocalFile()
@property (nonatomic, readwrite) BOOL wasRelative;
@end

@implementation ZG_SVGKSourceLocalFile
...
+ (ZG_SVGKSourceLocalFile*)sourceFromFilename:(NSString*)p {
	...
	ZG_SVGKSourceLocalFile* s = [[ZG_SVGKSourceLocalFile alloc] initWithInputSteam:stream];
	s.filePath = p;
...
+ (ZG_SVGKSourceLocalFile *)internalSourceAnywhereInBundle:(NSBundle *)bundle usingName:(NSString *)name
{
    ...
    ZG_SVGKSourceLocalFile* source = [ZG_SVGKSourceLocalFile sourceFromFilename: pathToFileInDocumentsFolder == nil ? pathToFileInBundle : pathToFileInDocumentsFolder];
...
- (ZG_SVGKSource *)sourceFromRelativePath:(NSString *)relative {
	...
	{
       ZG_SVGKSourceLocalFile* result = [ZG_SVGKSourceLocalFile sourceFromFilename:absolute];
