/**
 ...
 (c.f. ZG_Element vs ZG_Document - identical methods for getElementsByName)
 */
#import <Foundation/Foundation.h>

@class ZG_Node, ZG_NodeList, ZG_Element; // avoiding #import here, to avoid C header loop problems.

#define DEBUG_DOM_MATCH_ELEMENTS_IDS_AND_NAMES 0 // For debugging ZG_SVGKit: causes debug output on getElementById etc

@interface ZG_DOMHelperUtilities : NSObject
