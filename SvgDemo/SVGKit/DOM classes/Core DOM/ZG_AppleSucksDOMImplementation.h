/*
 ...
 ZG_DocumentType       createDocumentType(in DOMString qualifiedName, 
 in DOMString publicId, 
 in DOMString systemId)
 raises(DOMException);
 // Introduced in DOM Level 2:
 ZG_Document           createDocument(in DOMString namespaceURI, 
 in DOMString qualifiedName, 
 in ZG_DocumentType doctype)
 raises(DOMException);
 };
*/
...
@interface ZG_AppleSucksDOMImplementation : NSObject
