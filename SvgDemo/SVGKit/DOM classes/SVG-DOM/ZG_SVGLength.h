...
typedef enum ZG_SVG_LENGTH_TYPE
{
    ZG_SVG_LENGTHTYPE_UNKNOWN = 0,
    ZG_SVG_LENGTHTYPE_NUMBER = 1,
    ZG_SVG_LENGTHTYPE_PERCENTAGE = 2,
    ZG_SVG_LENGTHTYPE_EMS = 3,
    ZG_SVG_LENGTHTYPE_EXS = 4,
    ZG_SVG_LENGTHTYPE_PX = 5,
    ZG_SVG_LENGTHTYPE_CM = 6,
    ZG_SVG_LENGTHTYPE_MM = 7,
    ZG_SVG_LENGTHTYPE_IN = 8,
    ZG_SVG_LENGTHTYPE_PT = 9,
    ZG_SVG_LENGTHTYPE_PC = 10
} ZG_SVG_LENGTH_TYPE;


@interface ZG_SVGLength : NSObject

@property(nonatomic,readonly) ZG_SVG_LENGTH_TYPE unitType;
...
/** returns this ZG_SVGLength as if it had been converted to pixels, using [self convertToSpecifiedUnits:SVG_LENGTHTYPE_PX]
 */
-(float) pixelsValue;
...
/** returns this ZG_SVGLength as if it had been converted to a raw number (USE pixelsValue instead, UNLESS you are dealing with something that you expect to be a percentage or
