...
@implementation ZG_SVGGroupElement
...
/*
 FIXME: this cannot work; this is incompatible with the way that SVG spec was designed; this code comes from old ZG_SVGKit
 ...
 for( ZG_Node* node in self.attributes )
 {
