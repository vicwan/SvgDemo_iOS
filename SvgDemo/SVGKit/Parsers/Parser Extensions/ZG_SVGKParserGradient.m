...
{    
    ZG_Node *returnObject = nil;
    
    if( [name isEqualToString:@"linearGradient"] )
    {
        returnObject = currentElement = [[ZG_SVGLinearGradientElement alloc] initWithQualifiedName:name inNameSpaceURI:XMLNSURI attributes:attributes];
        ...
        returnObject = currentElement = [[ZG_SVGRadialGradientElement alloc] initWithQualifiedName:name inNameSpaceURI:XMLNSURI attributes:attributes];
        [currentElement postProcessAttributesAddingErrorsTo:parseResult];
    }
    else if( [name isEqualToString:@"stop"] )
    {
        ZG_SVGGradientStop *gradientStop = [[ZG_SVGGradientStop alloc] initWithQualifiedName:name inNameSpaceURI:XMLNSURI attributes:attributes];
