/**
 ...
 ZG_SVGKSource represents the info about where an SVG image's data came from ... from disk, from URL, from raw string - or anywhere
 
 ----
 NOTE: you should avoid instantiating ZG_SVGKSource directly; it is better to instantiate one of the subclasses, both because this
...
@interface ZG_SVGKSource : NSObject <NSCopying>
