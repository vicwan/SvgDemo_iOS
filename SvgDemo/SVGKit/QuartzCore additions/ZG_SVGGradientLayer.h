 ...
 */
@interface ZG_SVGGradientLayer : CAGradientLayer

@property (nonatomic, strong) ZG_SVGGradientElement *gradientElement;
@property (nonatomic, assign) CGRect objectRect;
@property (nonatomic, assign) ZG_SVGRect viewportRect;
